package org.opencorrelate.exercise.jvm.scala
...
class SocketTextStreamWordCountRunner extends CommandLineRunner {

    val log = LoggerFactory.getLogger(classOf[SocketTextStreamWordCountRunner])
...
object SocketTextStreamWordCount {
    ...
    def main(args: Array[String]): Unit = SpringApplication.run(classOf[SocketTextStreamWordCountRunner], args: _*)
